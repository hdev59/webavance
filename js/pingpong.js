function createPingPongDelay(ctx, isTrueStereo, delayTime, feedback) {
    var effect = new Effect();
    var merger = ctx.createChannelMerger(2);
    var leftDelay = ctx.createDelayNode();
    var rightDelay = ctx.createDelayNode();
    var leftFeedback = context.createGainNode();
    var rightFeedback = context.createGainNode();
